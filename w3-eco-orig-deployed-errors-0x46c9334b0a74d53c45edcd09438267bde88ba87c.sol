...
/**
 * @dev The official W3ECO smart contract
 */
contract W3ECO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "W3ECO (W3ECO.COM)";
    string private _symbol   = "W3ECO";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for W3ECO/WBNB
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion W3ECO will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-W3ECO tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts W3ECO balance for buybacks, Farming, liquidity and marketing
    ...
    /**
     * @notice Burns W3ECO tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of W3ECO tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from W3ECO)
